...
| Area | Level | What I have actually done |
| --- | --- | --- |
| PyTorch training and evaluation | Comfortable | Classification and segmentation training, external validation, metric computation; fixed splits and seeds |
| Medical imaging data | Comfortable | Ultrasound and CT preprocessing, augmentation, ROI handling; unified evaluation across datasets |
| Interpretability | Comfortable | Grad-CAM attention maps used to explain model decisions to clinicians |
| Model engineering | Some experience | Attempts at lightweight and on-device deployment, model export and inference packaging |
| NLP / small language models | Beginner | Fine-tuning and small-model inference experiments, still learning |
