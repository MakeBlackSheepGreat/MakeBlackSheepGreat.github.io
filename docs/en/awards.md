...
The entry was a breast tumour benign/malignant classification and diagnosis support system built on ultrasound images. Five-person team spanning biomedical engineering and computer science; I was responsible for algorithms and software — training and evaluating the CNN classifier, the Grad-CAM visualisation, and the demo system.
:::
...
The entry was the breast ultrasound diagnosis support system, and it was the first time I completed the full cycle of choosing a topic, running experiments, writing it up and defending it.
:::
...
These did not win anything. I list them anyway — they consumed as much time as the ones that did.
