...
我这一年用多套 Agent 框架做过真实项目（科研工作流、语料处理、服务部署、硬件设计流水线），对这两个判断都有自己的体会。下面是我目前的看法。
...
具体到做事层面，这七项在我这一年的实践里反复被证明是瓶颈所在：
...
**四、领域判断：知道什么值得做。** 模型能实现你提出的方案，但"该不该做这个方案"依赖对领域的理解。这一年我最省时间的决定，往往不是写得更快，而是提前砍掉了不值得做的方向。
